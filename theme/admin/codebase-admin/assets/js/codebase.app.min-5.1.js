...
!function () {
        ...
        1807: function (e) {
            ...
            e.exports = function (e, t, i) {
                ...
                if (o(e, !d(y) || !(b || w.forEach && !f((function () {
                    ...
                    var S = new x, L = S[_](b ? {} : -0, 1) != S, A = f((function () {
                        S.has(1)
                    })), O = p((function (e) {
                        new y(e)
                    })), j = !b && f((function () {
            ...
            e.exports = function (e, t, i, o, p, m, L) {
                ...
                if (M && (A = c(M.call(new e))) !== Object.prototype && A.next && (s || c(A) === _ || (u ? u(A, _) : a(A[w]) || f(A, w, S)), d(A, C, !0, !0), s && (g[C] = S)), v && p == E && I && I.name !== E && (!s && b ? h(P, "name", E) : (D = !0, N = function () {
                    ...
                    keys: m ? N : T(x),
                    entries: T(k)
                }, L) for (j in O) (y || D || !(j in P)) && f(P, j, O[j]); else n({
                    target: t,
                    proto: !0,
                    forced: y || D
                }, O);
            ...
            e.exports = function (e, t, i) {
                var n, v, b, _, y, w, x, E = i && i.that, k = !(!i || !i.AS_ENTRIES), S = !(!i || !i.IS_ITERATOR),
                    L = !(!i || !i.INTERRUPTED), A = r(t, E), O = function (e) {
            ...
            (x || k || E || f || p) && (v = function (e) {
                ...
                var A = p.groups, O = E && f.sticky, j = s(l, f), T = f.source, C = 0, D = S;
                ...
                })), r && A) for (r.groups = c = d(null), o = 0; o < A.length; o++) c[(u = A[o])[0]] = r[u[1]];
                return r
            }), e.exports = v
        }, 7066: function (e, t, i) {
            "use strict";
    ...
    i.n = function (e) {
            ...
            name: "arrow", enabled: !0, phase: "main", fn: function (e) {
                ...
                if (u && d) {
                    var g = function (e, t) {
                        ...
                        S = x - m[p] - g[b], L = x / 2 - m[p] / 2 + E, A = X(k, L, S), O = f;
        ...
        function Z(e) {
            ...
            if (p) {
                var A = V(i), j = "clientHeight", T = "clientWidth";
        ...
        var ee = {
            ...
            name: "eventListeners", enabled: !0, phase: "write", fn: function () {
                ...
                var t = e.state, i = e.instance, n = e.options, r = n.scroll, s = void 0 === r || r, o = n.resize,
                    a = void 0 === o || o, l = O(t.elements.popper),
        ...
        function de(e, t) {
            var i;
            void 0 === t && (t = []);
            var n = ue(e), r = n === (null == (i = e.ownerDocument) ? void 0 : i.body), s = O(n),
        ...
        function fe(e, t) {
            return t === h ? he(function (e) {
                var t = O(e), i = q(e), n = t.visualViewport, r = i.clientWidth, s = i.clientHeight, o = 0, a = 0;
        ...
        function ge(e, t) {
            ...
            var i = t, o = i.placement, a = void 0 === o ? e.placement : o, c = i.boundary, u = void 0 === c ? d : c,
                ...
                L = e.elements[y ? k : b], O = function (e, t, i) {
            ...
            name: "flip", enabled: !0, phase: "main", fn: function (e) {
                ...
                if (!t.modifiersData[u]._skip) {
                    for (var d = i.mainAxis, h = void 0 === d || d, f = i.altAxis, p = void 0 === f || f, v = i.fallbackPlacements, b = i.padding, _ = i.boundary, y = i.rootBoundary, w = i.altBoundary, x = i.flipVariations, E = void 0 === x || x, k = i.allowedAutoPlacements, S = t.options.placement, L = P(S), A = v || (L !== S && E ? function (e) {
                        ...
                        var M = O[N], F = P(M), R = G(M) === c, z = [n, r].indexOf(F) >= 0, B = z ? "width" : "height",
        ...
        var _e = {
            ...
            name: "preventOverflow", enabled: !0, phase: "main", fn: function (e) {
                var t = e.state, i = e.options, a = e.name, l = i.mainAxis, u = void 0 === l || l, d = i.altAxis,
                    ...
                    E = G(t.placement), k = !E, S = Q(x), L = "x" === S ? "y" : "x", A = t.modifiersData.popperOffsets,
                    O = t.rects.reference, j = t.rects.popper,
                ...
                if (A) {
                    if (u) {
                        var F, z = "y" === S ? n : o, B = "y" === S ? r : s, W = "y" === S ? "height" : "width",
                            q = A[S], H = q + w[z], $ = q - w[B], Y = b ? -j[W] / 2 : 0, U = E === c ? O[W] : j[W],
                            K = E === c ? -j[W] : -O[W], J = t.elements.arrow,
                            ...
                            ee = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : {
                                ...
                                bottom: 0,
                                left: 0
                            }, te = ee[z], ie = ee[B], ne = X(0, O[W], Z[W]),
                    ...
                    if (h) {
                        var de, he = "x" === S ? n : o, fe = "x" === S ? r : s, pe = A[L],
                            ...
                            xe = _e ? pe + O[me] + j[me] - ye - C.altAxis : be, Ee = b && _e ? function (e, t, i) {
                                var n = X(e, t, i);
                                return n > i ? i : n
        ...
        var Oe = Ae(), je = Ae({defaultModifiers: [ie, we, ee, D, ye, me, xe, K, _e]}),
        ...
        const xt = {
                ...
                wrap: "boolean",
                touch: "boolean"
            }, At = "next", Ot = "prev", jt = "left", Tt = "right", Ct = {ArrowLeft: Tt, ArrowRight: jt},
        ...
        const Si = "modal", Li = "Escape", Ai = {backdrop: !0, keyboard: !0, focus: !0},
            Oi = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean"}, ji = "hidden.bs.modal",
        ...
        const Sn = "active", Ln = "fade", An = "show", On = ".active", jn = ":scope > li > .active";
        ...
        var Un, Kn = function (e) {
            ...
            yr = function (e) {
            ...
            }, Lr = new WeakMap, Ar = function (e, t) {
                ...
                return e.connect = function (e, t) {
                    ...
                    var i = Lr.get(e), n = Ar(i.observationTargets, t), r = 1 === i.observationTargets.length;
        ...
        window.bootstrap = t, window.SimpleBar = Fr, window.Codebase = new class extends class {
            ...
            _uiInit() {
                this._lHtml = document.documentElement, this._lBody = document.body, this._lpageLoader = document.getElementById("page-loader"),
                    ...
                    this._lSidebarScroll = !1, this._lSideOverlayScroll = !1,
                    this._uiHandleTheme(), this._uiHandleDarkMode(),
                    this._uiHandleSidebars(), this._uiHandleHeader(),
                    this._uiHandleNav(), this._uiApiLayout(),
                    this._uiApiBlocks(), this.helpers(["bs-tooltip", "bs-popover", "cb-toggle-class", "cb-year-copy", "cb-ripple"]),
